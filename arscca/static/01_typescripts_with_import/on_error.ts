let on_error = () =>{
    ...
    var alertEngineersAndHalt = function(message:string){
        'use strict'
    ...
    var alertEngineersAndContinue = function(message:string){
        'use strict'
    ...
    var alertEngineersCommon = function(message:string, haltExecution?:boolean){
        'use strict'
    ...
    window.onerror = function(message:string, fileName:string, lineNumber:number, columnNumber:number, error) {
    ...
    // Consider this method private.
    // Only call it from the other methods defined on this page
    var sendDataToEngineers = function(details:Details){
        'use strict'
