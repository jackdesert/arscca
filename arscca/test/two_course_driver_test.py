...
class TwoCourseDriverTest(unittest.TestCase):
    ...
    def test_properties(self, slug_and_head_shot, factor, primary_score):
        ...
        expected = {'year': 2017, 'name': 'Rodrigo', 'car_class': 'ss', 'car_model': '4', 'car_number': '2', 'id': 'rodrigo--ss_2', 'second_half_started': True, 'runs_upper': ('7', '8', '9+1'), 'runs_lower': ('10', '11', '12'), 'published_primary_score': '100', 'primary_score': '37', 'secondary_score': '35.150', 'pax_factor': '0.95', 'slug': '', 'headshot': 'h'}
